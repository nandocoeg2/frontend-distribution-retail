...
export const useInvoicePengirimanQuery = ({
  ...
  return useQuery({
    queryKey: ['invoicePengiriman', { page, limit, sorting, filters, globalFilter, companyId }],
    queryFn: async () => {
      ...
      Object.entries(filters).forEach(([key, value]) => {
        ...
        // Handle no_lpb select filter → has_lpb backend param
        if (key === 'no_lpb' && (value === 'true' || value === 'false')) {
          params.has_lpb = value;
          return;
        }
