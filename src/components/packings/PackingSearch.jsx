...
import { usePackingStatuses } from '../../hooks/useStatusTypes';

const PackingSearch = ({ searchQuery, searchField, handleSearchChange, handleSearchFieldChange, searchLoading }) => {
  const { statuses: packingStatuses } = usePackingStatuses();
