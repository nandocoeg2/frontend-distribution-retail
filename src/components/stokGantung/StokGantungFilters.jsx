    ...
    return (
        <section className='rounded-xl border border-gray-200 bg-white p-3 shadow-sm'>
            <form onSubmit={(event) => event.preventDefault()}>
                {/* Row 1: Search + Status + Product + Date */}
                <div className='grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-12'>
                    <div className='lg:col-span-4'>
                        <label htmlFor='stok-gantung-search' className='sr-only'>
                            Search
                        </label>
                        <div className='relative'>
                            ...
                            <input
                                ...
                                className='block w-full rounded-lg border border-gray-300 bg-white py-1.5 pl-8 pr-3 text-sm transition focus:border-rose-500 focus:outline-none focus:ring-1 focus:ring-rose-500'
                            />
                        </div>
                    </div>
                    ...
                    <div className='lg:col-span-2'>
                        ...
                        <div className='relative'>
                            <select
                                ...
                                disabled={isLoading}
                                className='block w-full appearance-none rounded-lg border border-gray-300 bg-white py-1.5 pl-3 pr-8 text-sm transition focus:border-rose-500 focus:outline-none focus:ring-1 focus:ring-rose-500'
                            >
...
export default StokGantungFilters;
