    ...
    <div className='space-y-3'>
      <div className='flex items-center justify-between'>
        ...
        <button
          ...
          className='inline-flex items-center gap-1 rounded-md border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-rose-500'
        >
        ...
        {items.map((item, index) => (
          ...
          >
            ...
            <input
              ...
              placeholder='Qty'
              className='w-full rounded-md border border-gray-300 px-2.5 py-2 text-sm focus:border-rose-500 focus:outline-none focus:ring-1 focus:ring-rose-500'
            />
            <button
              type='button'
