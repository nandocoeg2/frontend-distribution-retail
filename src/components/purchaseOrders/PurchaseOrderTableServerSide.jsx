            ...
            <div className="flex items-center gap-2">
              ...
              {onBulkProcess && (
                <button
                  ...
                  disabled={isProcessing || isCancelling || isDeleting}
                  className={`inline-flex items-center px-2 py-1 text-xs text-white rounded ${isProcessing || isCancelling || isDeleting
