              ...
              <section>
                ...
                <div className='space-y-2'>
                  <InfoRow
                    ...
                    value={detail.no_kwitansi || '-'}
                  />
                  <InfoRow
                    label='Tanggal Kwitansi'
                    value={formatDate(detail.tanggal)}
                  />
                  <InfoRow label='Nama Penerima' value={detail.kepada || '-'} />
                  <InfoRow
                    label='Grand Total'
              ...
              <section>
                ...
                <div className='space-y-2'>
                  ...
                  <InfoRow
                    label='Kode Customer'
                    value={
                      detail?.invoicePenagihan?.customer?.kode_customer || '-'
                    }
                  />
                </div>
              </section>
...
export default KwitansiDetailModal;
