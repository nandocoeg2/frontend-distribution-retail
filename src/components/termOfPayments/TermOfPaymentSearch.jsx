...
const TermOfPaymentSearch = ({ searchQuery, handleSearchChange, handleSearchSubmit, searchLoading }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='relative w-full mb-2'>
      <input
        type='text'
        placeholder='Search term of payment, lalu tekan Enter'
        value={searchQuery}
...
export default TermOfPaymentSearch;
