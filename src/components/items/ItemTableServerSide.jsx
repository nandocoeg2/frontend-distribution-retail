    ...
    return (
        <div className="space-y-2">
            ...
            <DataTable
                ...
                wrapperClassName={`overflow-x-auto overflow-y-auto ${selectedItemId ? 'min-h-[250px] max-h-[calc(85vh-300px)]' : 'flex-1 min-h-[300px]'}`}
                ...
                getRowClassName={({ row }) => {
                    const isSelected = selectedItemId === row.original.id;
                    const isChecked = selectedItems.includes(row.original.id);
