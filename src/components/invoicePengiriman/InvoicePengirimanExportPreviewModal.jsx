...
const InvoicePengirimanExportPreviewModal = ({
  ...
  const formattedData = useMemo(() => {
    ...
    return previewData.data.map((row) => ({
      ...
      ppn_percentage: Number(row.ppn_percentage) || 0,
      grand_total: Number(row.grand_total) || 0,
    }));
  }, [previewData]);

  const getDynamicOptions = (field) => {
    const matchingRows = getMatchingInvoiceRowsExcluding(formattedData, columnFilters, field);
    const map = new Map();
  ...
  const invoiceOptions = useMemo(() => getDynamicOptions('no_invoice'), [formattedData, columnFilters]);
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor('tanggal_invoice', {
        ...
        header: ({ column }) => (
          <div className="space-y-0.5" onClick={(e) => e.stopPropagation()}>
            <div className="font-medium text-xs">Tanggal Invoice</div>
            <DateFilter
              value={column.getFilterValue() ?? ''}
          ...
          return (
            <span
              className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium whitespace-nowrap ${
                val.includes('LUNAS') || val.includes('PAID')
      ...
      columnHelper.accessor('harga', {
        ...
        header: ({ column }) => (
          <div className="space-y-0.5 text-right" onClick={(e) => e.stopPropagation()}>
            <div className="font-medium text-xs">Harga</div>
            <TextColumnFilter
              column={column}
              placeholder="Filter..."
              className="w-full px-2 py-1 text-xs text-right border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
        ...
        cell: (info) => (
          <div className="text-right text-gray-700 whitespace-nowrap pr-2">
            {Number(info.getValue() || 0).toLocaleString('id-ID')}
          </div>
        ),
        filterFn: (row, columnId, filterValue) => {
      ...
      columnHelper.accessor('potongan_a', {
        ...
        header: ({ column }) => (
          <div className="space-y-0.5 text-right" onClick={(e) => e.stopPropagation()}>
            <div className="font-medium text-xs">Disc A (%)</div>
            <TextColumnFilter
              column={column}
              placeholder="Filter..."
              className="w-full px-2 py-1 text-xs text-right border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
      ...
      columnHelper.accessor('harga_after_potongan_a', {
        ...
        header: ({ column }) => (
          <div className="space-y-0.5 text-right" onClick={(e) => e.stopPropagation()}>
            <div className="font-medium text-xs">Harga (Disc A)</div>
            <TextColumnFilter
              column={column}
              placeholder="Filter..."
              className="w-full px-2 py-1 text-xs text-right border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
      ...
      columnHelper.accessor('potongan_b', {
        ...
        header: ({ column }) => (
          <div className="space-y-0.5 text-right" onClick={(e) => e.stopPropagation()}>
            <div className="font-medium text-xs">Disc B (%)</div>
            <TextColumnFilter
              column={column}
              placeholder="Filter..."
              className="w-full px-2 py-1 text-xs text-right border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
      ...
      columnHelper.accessor('harga_after_potongan_b', {
        ...
        header: ({ column }) => (
          <div className="space-y-0.5 text-right" onClick={(e) => e.stopPropagation()}>
            <div className="font-medium text-xs">Harga (Disc B)</div>
            <TextColumnFilter
              column={column}
              placeholder="Filter..."
              className="w-full px-2 py-1 text-xs text-right border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
      ...
      columnHelper.accessor('total', {
        ...
        cell: (info) => (
          <div className="text-right font-medium text-gray-900 whitespace-nowrap pr-2">
            {Number(info.getValue() || 0).toLocaleString('id-ID')}
          </div>
        ),
        filterFn: (row, columnId, filterValue) => {
      ...
      columnHelper.accessor('total_discount', {
        ...
        header: ({ column }) => (
          <div className="space-y-0.5 text-right" onClick={(e) => e.stopPropagation()}>
            <div className="font-medium text-xs">Total Disc</div>
            <TextColumnFilter
              column={column}
              placeholder="Filter..."
              className="w-full px-2 py-1 text-xs text-right border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
      ...
      columnHelper.accessor('ppn_percentage', {
        id: 'ppn_percentage',
        header: ({ column }) => (
          <div className="space-y-0.5 text-right" onClick={(e) => e.stopPropagation()}>
      ...
      columnHelper.accessor('grand_total', {
        ...
        header: ({ column }) => (
          <div className="space-y-0.5 text-right" onClick={(e) => e.stopPropagation()}>
            <div className="font-medium text-xs">Grand Total</div>
            <TextColumnFilter
              column={column}
              placeholder="Filter..."
              className="w-full px-2 py-1 text-xs text-right border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500"
        ...
        cell: (info) => (
          <div className="text-right font-bold text-gray-900 whitespace-nowrap pr-2">
            {Number(info.getValue() || 0).toLocaleString('id-ID')}
          </div>
        ),
        filterFn: (row, columnId, filterValue) => {
...
export default InvoicePengirimanExportPreviewModal;
