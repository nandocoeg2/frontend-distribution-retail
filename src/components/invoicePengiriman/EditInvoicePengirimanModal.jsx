...
const EditInvoicePengirimanModal = ({
  ...
  useEffect(() => {
    if (show && invoice) {
      setFormData({
        ...
        expired_date: invoice.expired_date ? invoice.expired_date.substring(0, 10) : '',
        TOP: toStringValue(invoice.TOP),
        type: toStringValue(invoice.type || 'PENGIRIMAN'),
  ...
  const recalculateFinancials = () => {
    ...
    toastService.info('Nilai finansial dihitung otomatis. Silakan simpan untuk menerapkan.');
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await invoicePengirimanService.updateInvoicePengiriman(invoice.id, payload);
        ...
        {invoiceError ? (
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-8">
            <section>
              ...
              <p className="text-sm text-gray-500">Perbarui data pelanggan dan ketentuan pembayaran.</p>
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  <label htmlFor="deliver_to" className="mb-1 block text-sm font-medium text-gray-700">Tujuan Pengiriman *</label>
                  <input
                    id="deliver_to"
                    name="deliver_to"
                    type="text"
                ...
                <div>
                  <label htmlFor="expired_date" className="mb-1 block text-sm font-medium text-gray-700">Tanggal Jatuh Tempo</label>
                  <input
                    id="expired_date"
                    name="expired_date"
                    type="date"
                ...
                <div>
                  <label htmlFor="TOP" className="mb-1 block text-sm font-medium text-gray-700">Term of Payment</label>
                  <input
                    id="TOP"
                    name="TOP"
                    type="text"
                ...
                <div>
                  <label htmlFor="type" className="mb-1 block text-sm font-medium text-gray-700">Tipe Invoice</label>
                  <select
                    id="type"
                    name="type"
                    value={formData.type}
            ...
            <section>
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Rincian Finansial</h3>
                  <p className="text-sm text-gray-500">Pastikan nilai sesuai dengan dokumen dan perhitungan pajak.</p>
                </div>
                <button
                  type="button"
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  <label htmlFor="sub_total" className="mb-1 block text-sm font-medium text-gray-700">Sub Total *</label>
                  <input
                    id="sub_total"
                    name="sub_total"
                    type="number"
                ...
                <div>
                  <label htmlFor="total_discount" className="mb-1 block text-sm font-medium text-gray-700">Total Diskon</label>
                  <input
                    id="total_discount"
                    name="total_discount"
                    type="number"
                ...
                <div>
                  <label htmlFor="total_price" className="mb-1 block text-sm font-medium text-gray-700">Total Harga *</label>
                  <input
                    id="total_price"
                    name="total_price"
                    type="number"
                ...
                <div>
                  <label htmlFor="ppn_percentage" className="mb-1 block text-sm font-medium text-gray-700">PPN (%)</label>
                  <input
                    id="ppn_percentage"
                    name="ppn_percentage"
                    type="number"
                ...
                <div>
                  <label htmlFor="ppn_rupiah" className="mb-1 block text-sm font-medium text-gray-700">PPN (Rp)</label>
                  <input
                    id="ppn_rupiah"
                    name="ppn_rupiah"
                    type="number"
                ...
                <div>
                  <label htmlFor="grand_total" className="mb-1 block text-sm font-medium text-gray-700">Grand Total *</label>
                  <input
                    id="grand_total"
                    name="grand_total"
                    type="number"
